...
--MOVIES--
INSERT INTO MOVIES (ID,VERSION,NAME,RELEASE_DATE,DIRECTOR_ID,DESCRIPTION) VALUES (0,0,'Interstellar','2014-11-07',1,'');
INSERT INTO MOVIES (ID,VERSION,NAME,RELEASE_DATE,DIRECTOR_ID,DESCRIPTION) VALUES (1,0,'Dazed and Confused','1994-02-10',0,'');
INSERT INTO MOVIES (ID,VERSION,NAME,RELEASE_DATE,DIRECTOR_ID,DESCRIPTION) VALUES (2,0,'Charlie and the Chocolate Factory','2005-07-15',2,'');
INSERT INTO MOVIES (ID,VERSION,NAME,RELEASE_DATE,DIRECTOR_ID,DESCRIPTION) VALUES (3,0,'Fear and Loathing in Las Vegas','1998-05-22',3,'');
INSERT INTO MOVIES (ID,VERSION,NAME,RELEASE_DATE,DIRECTOR_ID,DESCRIPTION) VALUES (4,0,'Spider-Man','2002-05-03'4,,'');
INSERT INTO MOVIES (ID,VERSION,NAME,RELEASE_DATE,DIRECTOR_ID,DESCRIPTION) VALUES (5,0,'Bridget Jones Diary ','2001-04-13',5,'');
INSERT INTO MOVIES (ID,VERSION,NAME,RELEASE_DATE,DIRECTOR_ID,DESCRIPTION) VALUES (6,0,'Marie Antoinette','2006-10-20',6,'');
INSERT INTO MOVIES (ID,VERSION,NAME,RELEASE_DATE,DIRECTOR_ID,DESCRIPTION) VALUES (7,0,'Inside Job','2010-11-12',7,'');
INSERT INTO MOVIES (ID,VERSION,NAME,RELEASE_DATE,DIRECTOR_ID,DESCRIPTION) VALUES (8,0,'Good Will Hunting','1997-01-09',9,'');
INSERT INTO MOVIES (ID,VERSION,NAME,RELEASE_DATE,DIRECTOR_ID,DESCRIPTION) VALUES (9,0,'The Intern','2015-09-25',8,'');

--MOVIES_ACTORS--

INSERT INTO MOVIES_ACTORS (MOVIES_ID,ACTORS_ID) VALUES (1,2);
INSERT INTO MOVIES_ACTORS (MOVIES_ID,ACTORS_ID) VALUES (1,3);
INSERT INTO MOVIES_ACTORS (MOVIES_ID,ACTORS_ID) VALUES (1,4);
INSERT INTO MOVIES_ACTORS (MOVIES_ID,ACTORS_ID) VALUES (1,5);
INSERT INTO MOVIES_ACTORS (MOVIES_ID,ACTORS_ID) VALUES (1,6);
